            ...
            FileService.searchServices(keywords, (serviceList) {
                if (textEditingController.text == input) {
                  ...
                  setState(() {
                      ...
                      title = '搜索结果(' + (page + 1).toString() + '/' + (fileServiceList.length~/ 18 + 1).toString() + ')';
                      });
                  }
                });
            },
          ...
          if (!centerSearch) {
            if (fileServiceList.length > 0) {
              list.add(new Expanded(
                  child: ListView.builder(
                    ...
                    itemCount: fileServiceList.length - page * 18 > 18 ? 20 : fileServiceList.length - page * 18,
                    itemBuilder: (context, index) {
                      ...
                      if (index == 0) {
                        if (page != 0) {
                          ...
                          return new ListTile(title: new Text('全部文档: '), );
                        }
                        if (index != 19) {
                          return new ListTile(
                            trailing: new CollectionButton(),
            ...
            Widget build(BuildContext context) => new Scaffold(
              appBar: new AppBar(
                ...
                actions: < Widget > [
                  new IconButton(
                    icon: Icon(Icons.list, color: Colors.white, size: 30.0, ),
